...
//(function (e) {
//    var t = { sectionContainer: "section", easing: "ease", animationTime: 1000, pagination: true, updateURL: false, keyboard: true, beforeMove: null, afterMove: null, loop: true, responsiveFallback: false, direction: "vertical" };
...
//                pos = (t - 1) * 100 * -1;
//                if (history.replaceState && r.updateURL == true) {
//                    var n = window.location.href.substr(0, window.location.href.indexOf("#")) + "#" + t;
//                    history.pushState({}, document.title, n)
//                }
